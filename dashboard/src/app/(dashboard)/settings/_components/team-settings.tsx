      ...
      <div className="rounded-lg border border-border bg-bg-1 p-6">
        ...
        <div className="mt-4 space-y-3 text-sm">
          ...
          <div>
            ...
            <span className="font-mono text-text-primary">{team.id}</span>
          </div>
          <div>
      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        ...
        <div>
          ...
          <div className="flex items-center gap-2">
            <code className="flex-1 rounded-md border border-border bg-bg-2 px-4 py-2 font-mono text-sm text-text-muted">
              {team.id}
            </code>
            <button
              type="button"
              onClick={handleCopyId}
              className="flex items-center gap-1.5 rounded-md border border-border bg-bg-2 px-3 py-2 text-sm text-text-secondary transition-colors hover:bg-bg-3 hover:text-text-primary"
          ...
          <p className="mt-1 text-xs text-text-muted">
            Sync is enabled automatically during setup. If you declined, run: <code className="text-accent-400">grov sync --enable --team {team.id.slice(0, 8)}...</code>
          </p>
        </div>
