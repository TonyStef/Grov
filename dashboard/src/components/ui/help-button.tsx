...
export function HelpButton() {
  ...
  return (
    <a
      href="https://discord.gg/Pz5P6Havr7"
      target="_blank"
      rel="noopener noreferrer"
      className="fixed bottom-4 right-4 z-40 flex items-center gap-2 rounded-full bg-accent-400 px-3 py-2 text-bg-0 shadow-lg transition-all hover:bg-accent-500 hover:shadow-xl"
